...
class TasksView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StoreConnector<TasksState, TasksState>(
      converter: (Store<TasksState> store) => store.state,
      onInit: (Store<TasksState> store) => TasksScope.fetchTasks(context, null),
